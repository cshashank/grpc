...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.skc.grpc.helloworld.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.skc.grpc.helloworld.Person,
      com.skc.grpc.helloworld.Greeting> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.skc.grpc.helloworld.Person.class,
      responseType = com.skc.grpc.helloworld.Greeting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.skc.grpc.helloworld.Person,
      com.skc.grpc.helloworld.Greeting> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.skc.grpc.helloworld.Person, com.skc.grpc.helloworld.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.skc.grpc.helloworld.Person, com.skc.grpc.helloworld.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.skc.grpc.helloworld.HelloWorldService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.skc.grpc.helloworld.Person.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.skc.grpc.helloworld.Person request,
        io.grpc.stub.StreamObserver<com.skc.grpc.helloworld.Greeting> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.skc.grpc.helloworld.Person,
                com.skc.grpc.helloworld.Greeting>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public com.skc.grpc.helloworld.Greeting sayHello(com.skc.grpc.helloworld.Person request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.skc.grpc.helloworld.Greeting> sayHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.skc.grpc.helloworld.Person) request,
              (io.grpc.stub.StreamObserver<com.skc.grpc.helloworld.Greeting>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.skc.grpc.helloworld.HelloWorld.getDescriptor();
    }
